...
func RegisterStubStrategies(r *controller.Registry) {
	...
	pages := []string{
		...
		"EngagementSurveyFeedbackPage", "SingleInteractionPage", "FulfillmentQuestionsResponsesCountPage",
		"FulfillmentQuestionResponsesPage", "FulfillmentUserResponsesPage",
